...
class SheetController extends Controller
{
    ...
    public function getSiteData(Request $request)
    {
        ...
        if($count > 0)
        {
            ...
            $foot = "<tr><td>Total</td><td>$currencyStr $s_spent</td><td>$currencyStr $s_gSpent</td><td>$currencyStr $s_rMax</td><td>$s_roiMin%</td><td>$s_roiMax%</td><td>$currencyStr $s_lMin</td><td>$currencyStr $s_lMax</td><td>$s_clicks</td><td>$currencyStr $s_bidAcutal</td><td>$currencyStr $s_bidAmount</td><td>$currencyStr $s_bidMax</td><td>-</td></tr>";
        }
        ...
        if(request()->ajax()) {
            ...
            foreach ($all_sitelist as $val)
            {
                ...
                if(!in_array($site, $all_blocksitelist))
                    $contentHtml .= "<td><input type='checkbox' data-id='$site' data-plugin='switchery' checked /></td>";
                else
                    $contentHtml .= "<td><input type='checkbox' data-id='$site' data-plugin='switchery' /></td>";
