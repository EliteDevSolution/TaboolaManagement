            ...
            <div class="col-12">
                <div class="card m-b-20">
                    <div class="card-block">
                        <form method="POST" action="{{ route('campaigns.update', $result['id']) }}" id="cmp_form">
                            {{ csrf_field() }}
                            {{ method_field('PUT') }}
                            ...
                            @endif">
                                ...
                                <div class="col-sm-6">
                                    <input name="name" class="form-control" type="text" value="{{ old('name', sizeof($result) > 0 ? $result['name'] : '') }}" id="cmp_name" required>
                                    @if ($errors->has('name'))
